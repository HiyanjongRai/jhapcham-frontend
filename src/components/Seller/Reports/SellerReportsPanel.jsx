                    ...
                    {selectedReport ? (
                        <div className="rd-content animate-in">
                            ...
                            {selectedReport.evidenceUrls && selectedReport.evidenceUrls.length > 0 && (
                                <div className="rd-description" style={{ marginTop: '24px' }}>
                                   <label><MessageSquare size={14}/> ATTACHED EVIDENCE</label>
                                   <div style={{ display: 'flex', gap: '12px', marginTop: '12px' }}>
                                      {selectedReport.evidenceUrls.map((url, i) => (
                                          <a key={i} href={url.startsWith('http') ? url : `${API_BASE}/${url}`} target="_blank" rel="noreferrer">
                                             <img src={url.startsWith('http') ? url : `${API_BASE}/${url}`} alt={`Evidence ${i}`} style={{ width: '100px', height: '100px', objectFit: 'cover', borderRadius: '12px', border: '2px solid #f1f5f9' }} />
                                          </a>
                                      ))}
                                   </div>
                                </div>
